...
function en.lang()-- in-table function 
    local info = 
    {
        ...
        help = {
            referral = '*Referral Program*\nUse this service to get more credits by inviting users to join *#botusername*\nYou will get *#earn SP* for each unique users if the invited user joins and successfully registers in our services, he gets *earnRegister SP* and you get "#earnRefer SP" for invited him.\n[INVITE USERS Now](#invitelink)',
