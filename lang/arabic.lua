...
function en.lang()-- in-table function 
    local info = 
    {
        ...
        help = {
            referral = '*قسم الاحالات*\nيمكنك استخدام هذا القسم لدعوة اعضاء لـ *#botusername*\nسوف تحصل على *#earn SP* لكل عضو مميز يقوم بالدخول للبوت عن طريق رابط الاحالة الخاص بك و قيامه بالتسجيل في خدماتنا, سوف يحصل العضو المدعو على *#earnRegister SP* و سوف تحصل انت على "#earnRefer SP" لانك قمت بأحالته لنا.\n[استخدم رابط احالتك الان](#invitelink)',
