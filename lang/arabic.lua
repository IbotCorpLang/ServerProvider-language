...
function ar.lang()-- in-table function 
    local info = 
    {
		...
		reinstall_server = {
			...
			text2 = 'تم اعادة تعيين.\nيرجى الانتظار لمدة تصل الى 45 دقيقة للوصول الى الخادم مرة اخرى.',
