...
function ar.lang()-- in-table function 
    local info = 
    {
        ...
        register = {
            text = "مرحبا بك في [بوت موفر الخوادم](https://t.me/#botusername)\nللأستمرار في استخدام بوت موفر الخوادم عليك الموافقه على [الاحكام و شروط](#link) استخدام بوت موفر الخوادم",
	    text2 = "مرحبا بك في [بوت موفر الخوادم](https://t.me/#botusername)\nعلينا التحقق من انك لست روبوت, رجاءا قم بزيارة الصفحة في الاسفل",
            keyboard = {
                {
        ...
        newserver = {-- New server texts, do not change these words (#n, #b, #m, #servername, #servertime, #expiredate, #price, #name, {name}, )
            ...
            keyboard3 = {
                {
                    {text = 'الغاء', callback_data = 'cancel_server'},
                    {text = 'صنع الان', callback_data = 'sendserver'}
                    },
                },
            keyboard4 = {
                {
